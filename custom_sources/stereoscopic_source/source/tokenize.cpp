...
const RESERVED_WORD Reserved_Words[LAST_TOKEN] = {
  ...
  {STEREOPANORAMA_TOKEN,"stereopanorama"},
  {STEREOSPHERICAL_TOKEN,"stereospherical"},
  {STEREOFISHEYE1_TOKEN,"stereofisheye1"},
  {STEREOFISHEYE2_TOKEN,"stereofisheye2"},
  {ZEROPARALLAX_TOKEN,"zeroparallax"},
  {EYEOFFSET_TOKEN,"eyeoffset"},
  {OFFSETFISHEYE_TOKEN,"offsetfisheye"},
  {FISHXOFFSET_TOKEN,"fishxoffset"},
  {FISHYOFFSET_TOKEN,"fishyoffset"},
  {FISHZOFFSET_TOKEN,"fishzoffset"},
