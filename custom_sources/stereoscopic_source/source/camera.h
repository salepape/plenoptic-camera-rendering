...
#define STEREOPANORAMA_CAMERA   21
#define STEREOSPHERICAL_CAMERA  22
#define OFFSETFISHEYE_CAMERA    23
#define STEREOFISHEYE1_CAMERA   24
#define STEREOFISHEYE2_CAMERA   25
